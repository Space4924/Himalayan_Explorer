...
const SignIn = () => {
    ...
    const SubmitData = async (e) => {
        ...
        }).catch((err) => alert('Invalid Credentials please Fill correct'));
        ...
        <main className="w-full h-screen flex flex-col items-center justify-center px-4">
            <div className="max-w-sm w-full text-gray-600 space-y-8">
                <div className="text-center">
                    <img src="himalayan_logo.png" width={150} className="mx-auto" />
                    <div className="mt-5 space-y-2">
                        <h3 className="text-gray-800 text-2xl font-bold sm:text-3xl">Sign In</h3>
                        <p className="">Don't have an account? <a href="javascript:void(0)" className="font-medium text-indigo-600 hover:text-indigo-500"><Link to='/signup'>Sign up</Link></a></p>
                    </div>
                </div>
                <form
